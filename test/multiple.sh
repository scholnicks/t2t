...
cat > /tmp/multiple_expected.html << __DATA__
...
/Users/scholnick/perl/t2t/t2t.pl --tables --init /tmp/multiple.rc < /Users/scholnick/perl/t2t/test/multiple > /tmp/multiple_actual.html

results=`diff -b -B -i -w /tmp/multiple_expected.html /tmp/multiple_actual.html`
...
# rm -f /tmp/multiple_expected.html /tmp/multiple_actual.html /tmp/multiple.rc
